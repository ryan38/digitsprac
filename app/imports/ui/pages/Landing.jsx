        ...
        <div className='digits-landing-background'>
          <Grid container stackable cenetered columns={3}>
            ...
            <Grid.Column textAlign='center'>
              ...
              <Header as='h3' inverted> This address book enables any number of users to login and save their business
            ...
            <Grid.Column textAlign='center'>
              ...
              <Header as='h3' inverted> Each time you make a contact, you can write a note that summarizes the
